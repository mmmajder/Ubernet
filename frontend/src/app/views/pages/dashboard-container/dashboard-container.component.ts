...
export class DashboardContainerComponent implements OnInit, OnDestroy {
  ...
  constructor(private store: Store, private router: Router, private authService: AuthService, private webSocketService: WebsocketService) {
  }
  ...
  ngOnInit(): void {
    this.store.dispatch(new CurrentlyLogged()).subscribe({
      next: (resp) => {
        ...
        // this.webSocketService.openWebSocket(this.user.email);
      },
