...
public class EmailContentUtils {
    ...
    private static String originalTemplate(String title, String body, String buttonText) {
        ...
        String content = "<!-- Automatically generated by make_email v0.8.0. Do not edit this file. -->\r\n"
                ...
                + "                              \r\n"
                + "                              <span style=\"font-family: Gill Sans,Gill Sans MT,Calibri,sans-serif; font-size: 60px; color:#FFC107\" > \r\n"
                + "                                Ubernet\r\n"
                + "                              </span>\r\n"
                + "\r\n"
                + "                            </div>\r\n"
                ...
                + "                              <img width=\"100%\" style=\"max-width: 600px; height: auto\" src=\"https://cdn.pixabay.com/photo/2019/09/26/18/18/letter-4506689_960_720.png\" alt=\"Lyft business profile\" />\r\n"
                + "                            </td>\r\n"
                + "                          </tr>\r\n"
                + "                        </table>\r\n"
                + "                        <!--END HERO IMAGE-->\r\n"
                ...
                + "                                <tr>\r\n"
                + "                                  <td class=\"cta-shadow\" align=\"center\" bgcolor=\"#FFC107\"\" style=\"border-radius: 40px; -webkit-border-radius: 40px; -moz-border-radius: 40px;\">\r\n"
                + button
                + "                                  </td>\r\n"
                + "                                </tr>\r\n"
                + "                              </table>\r\n"
                ...
                + "                            185 FTN Street, Novi Sad 21000, Serbia<br/>&#169; Copyright © 2022-2023 Krindž.</td>\r\n"
                + "                        </tr>\r\n"
                + "                        <!--===========CUSTOMER ACTIONS===========-->\r\n"
                + "                      </table>\r\n"
